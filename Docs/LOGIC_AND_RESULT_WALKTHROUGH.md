...
- database connection ที่ [cmd/server/main.go](../cmd/server/main.go#L24)
- middleware registration ที่ [cmd/server/main.go](../cmd/server/main.go#L30)
- repositories ที่ [cmd/server/main.go](../cmd/server/main.go#L36)
- services ที่ [cmd/server/main.go](../cmd/server/main.go#L43)
- handlers ที่ [cmd/server/main.go](../cmd/server/main.go#L51)
- pricing routes ที่ [cmd/server/main.go](../cmd/server/main.go#L91)
- audit routes ที่ [cmd/server/main.go](../cmd/server/main.go#L102)
...
| Go Fiber API Post `/api/v1/pricing/calculate` | [cmd/server/main.go](../cmd/server/main.go#L92), [internal/handler/pricing_handler.go](../internal/handler/pricing_handler.go#L21) | รับ request และ parse body | `PricingService` |
| Middleware Validate/Auth/Request ID/Error | [internal/middleware/request_id.go](../internal/middleware/request_id.go#L10), [internal/handler/pricing_handler.go](../internal/handler/pricing_handler.go#L53), [internal/handler/api_error.go](../internal/handler/api_error.go#L14) | ใส่ request ID และ map error กลับเป็น HTTP response | handler/service |
| Pricing Service | [internal/service/pricing_service.go](../internal/service/pricing_service.go#L26) | orchestration การคำนวณราคา | product repo, promotion repo, promotion engine, calculation log |
| Promotion Repository | [internal/repository/promotion_repository.go](../internal/repository/promotion_repository.go#L74) | โหลด promotions ที่ active พร้อม targets/conditions/actions | `PricingService` |
| Product Repository | [internal/repository/product_repository.go](../internal/repository/product_repository.go#L45) | โหลดข้อมูลสินค้าและราคา | `PricingService` |
| MySQL + GORM | [cmd/server/main.go](../cmd/server/main.go#L24), [internal/repository/promotion_repository.go](../internal/repository/promotion_repository.go#L77), [internal/repository/product_repository.go](../internal/repository/product_repository.go#L45) | เก็บ product/promotion/log data | repositories/services |
| Promotion Engine | [internal/promotion/engine.go](../internal/promotion/engine.go#L100) | ประมวลผล business rules จริง | ส่ง `CalculationResult` กลับ `PricingService` |
| Check Target | [internal/promotion/engine.go](../internal/promotion/engine.go#L175), [internal/promotion/engine.go](../internal/promotion/engine.go#L529) | ตรวจว่าตะกร้าตรง target ของโปรหรือไม่ | ถ้าผ่านไป check condition |
| Check Condition | [internal/promotion/engine.go](../internal/promotion/engine.go#L179), [internal/promotion/engine.go](../internal/promotion/engine.go#L269) | ตรวจ coupon, amount, date, payment, etc. | ถ้าผ่านไป apply action |
| Sort Promotion | [internal/promotion/engine.go](../internal/promotion/engine.go#L107) | เรียงตาม scope, priority, createdAt, id | loop ของ engine |
| Stacking Policy | [internal/model/models.go](../internal/model/models.go#L74), [internal/promotion/engine.go](../internal/promotion/engine.go#L155) | enforce `stackable`, `exclusive`, `stopProcessing`, `conflictGroup` | loop ของ engine |
| Strategy Pattern | [internal/promotion/registry.go](../internal/promotion/registry.go#L24), [internal/promotion/engine.go](../internal/promotion/engine.go#L238) | map action/condition type ไปยัง handler | คำนวณ discount และ skip reason |
| Percentage Strategy | [internal/promotion/engine.go](../internal/promotion/engine.go#L296) | คำนวณส่วนลดแบบเปอร์เซ็นต์ | apply ลง item/cart |
| Fixed Amount Strategy | [internal/promotion/engine.go](../internal/promotion/engine.go#L316) | คำนวณส่วนลดแบบจำนวนเงินคงที่ | apply ลง item/cart |
| Future Strategy | [internal/promotion/registry.go](../internal/promotion/registry.go#L69), [internal/promotion/engine.go](../internal/promotion/engine.go#L339) | เปิดช่องให้เพิ่ม strategy ใหม่ | บางส่วนทำงานจริง, บางส่วนยัง placeholder |
| Calculate Result | [internal/promotion/engine.go](../internal/promotion/engine.go#L226) | สรุป totals และ applied/skipped promotions | `PricingService` |
| Validate Discount | [internal/promotion/engine.go](../internal/promotion/engine.go#L328), [internal/promotion/engine.go](../internal/promotion/engine.go#L229) | กันไม่ให้ discount เกิน base และไม่ให้ final total ติดลบ | final result |
| Calculation Result | [internal/dto/pricing_dto.go](../internal/dto/pricing_dto.go#L50), [internal/service/pricing_service.go](../internal/service/pricing_service.go#L142) | shape ของ response JSON | handler ส่งกลับ client |
| Calculation Log Service | [internal/service/pricing_service.go](../internal/service/pricing_service.go#L196), [internal/service/calculation_log_service.go](../internal/service/calculation_log_service.go#L21) | persist และ replay calculation snapshot | MySQL / audit API |
...
- `POST /api/v1/pricing/calculate` ที่ [cmd/server/main.go](../cmd/server/main.go#L92)
- `POST /api/v1/pricing/explain` ที่ [cmd/server/main.go](../cmd/server/main.go#L93)

สิ่งนี้สอดคล้องกับภาพที่มี `Go Fiber API Post /api/v1/pricing/calculate`

### Handler layer

handler รับ request และ parse body ที่ [internal/handler/pricing_handler.go](../internal/handler/pricing_handler.go#L21)
...
โค้ดอยู่ที่ [internal/middleware/request_id.go](../internal/middleware/request_id.go#L10)
...
middleware นี้ถูก mount ทั้ง app ที่ [cmd/server/main.go](../cmd/server/main.go#L30)
...
- `Calculate()` ที่ [internal/service/pricing_service.go](../internal/service/pricing_service.go#L52)
- `Explain()` ที่ [internal/service/pricing_service.go](../internal/service/pricing_service.go#L58)
- `Preview()` ที่ [internal/service/pricing_service.go](../internal/service/pricing_service.go#L64)

ทั้งสามเมทอดวิ่งเข้าฟังก์ชันกลางตัวเดียวคือ `calculate(...)` ที่ [internal/service/pricing_service.go](../internal/service/pricing_service.go#L70)
...
ที่ [internal/service/pricing_service.go](../internal/service/pricing_service.go#L71)
...
ที่ [internal/service/pricing_service.go](../internal/service/pricing_service.go#L75)

ฟังก์ชัน `aggregateItems()` ที่ [internal/service/pricing_service.go](../internal/service/pricing_service.go#L224) ทำ 2 อย่าง:
...
ที่ [internal/service/pricing_service.go](../internal/service/pricing_service.go#L80)

service เรียก `productRepo.FindByIDs(...)`

repository implementation อยู่ที่ [internal/repository/product_repository.go](../internal/repository/product_repository.go#L45)
...
ที่ [internal/service/pricing_service.go](../internal/service/pricing_service.go#L84)
...
ที่ [internal/service/pricing_service.go](../internal/service/pricing_service.go#L90)
...
ที่ [internal/service/pricing_service.go](../internal/service/pricing_service.go#L104)
...
ที่ [internal/service/pricing_service.go](../internal/service/pricing_service.go#L123)

service เรียก `promotionRepo.FindActivePromotions(ctx, time.Now())`

implementation อยู่ที่ [internal/repository/promotion_repository.go](../internal/repository/promotion_repository.go#L74)
...
ที่ [internal/service/pricing_service.go](../internal/service/pricing_service.go#L128)
...
entry point ของ engine อยู่ที่ [internal/promotion/engine.go](../internal/promotion/engine.go#L100)
...
ที่ [internal/promotion/engine.go](../internal/promotion/engine.go#L100)

### 8.2 sort promotions

ที่ [internal/promotion/engine.go](../internal/promotion/engine.go#L107)
...
- [internal/promotion/engine.go](../internal/promotion/engine.go#L107)

นี่คือ implementation ของกล่อง `3. Sort Promotion`

### 8.3 สร้าง result object

ที่ [internal/promotion/engine.go](../internal/promotion/engine.go#L122)
...
ที่ [internal/promotion/engine.go](../internal/promotion/engine.go#L132)
...
loop หลักเริ่มที่ [internal/promotion/engine.go](../internal/promotion/engine.go#L147)
...
- จุดเรียกที่ [internal/promotion/engine.go](../internal/promotion/engine.go#L148)
...
ที่ [internal/promotion/engine.go](../internal/promotion/engine.go#L148)
...
- [internal/promotion/engine.go](../internal/promotion/engine.go#L155)
...
ที่ [internal/promotion/engine.go](../internal/promotion/engine.go#L171)
...
จุดเรียกอยู่ที่ [internal/promotion/engine.go](../internal/promotion/engine.go#L175)

logic จริงอยู่ที่:

- `evaluateTargets(...)` ที่ [internal/promotion/engine.go](../internal/promotion/engine.go#L529)
- `matchedItemIndexes(...)` ที่ [internal/promotion/engine.go](../internal/promotion/engine.go#L562)
...
จุดเรียกอยู่ที่ [internal/promotion/engine.go](../internal/promotion/engine.go#L179)

condition evaluation function:

- [internal/promotion/engine.go](../internal/promotion/engine.go#L269)
...
- `MIN_ORDER_AMOUNT` ที่ [internal/promotion/engine.go](../internal/promotion/engine.go#L345)
- `MAX_ORDER_AMOUNT` ที่ [internal/promotion/engine.go](../internal/promotion/engine.go#L355)
- `COUPON_CODE` ที่ [internal/promotion/engine.go](../internal/promotion/engine.go#L365)
- `PAYMENT_METHOD` ที่ [internal/promotion/engine.go](../internal/promotion/engine.go#L377)
- `PRODUCT_ID` ที่ [internal/promotion/engine.go](../internal/promotion/engine.go#L387)
- `CATEGORY_ID` ที่ [internal/promotion/engine.go](../internal/promotion/engine.go#L399)
- `DATE_RANGE` ที่ [internal/promotion/engine.go](../internal/promotion/engine.go#L411)
...
registry mapping อยู่ที่ [internal/promotion/registry.go](../internal/promotion/registry.go#L107)
...
จุดเรียก action handler อยู่ที่ [internal/promotion/engine.go](../internal/promotion/engine.go#L241)
...
`percentageActionHandler` อยู่ที่ [internal/promotion/engine.go](../internal/promotion/engine.go#L296)
...
`fixedAmountActionHandler` อยู่ที่ [internal/promotion/engine.go](../internal/promotion/engine.go#L316)
...
`FREE_SHIPPING` ถูก register แล้วที่ [internal/promotion/registry.go](../internal/promotion/registry.go#L97)

แต่ handler ปัจจุบันคืน `0` ที่ [internal/promotion/engine.go](../internal/promotion/engine.go#L339)
...
- `applyPromotion(...)` ที่ [internal/promotion/engine.go](../internal/promotion/engine.go#L238)
- `applyToItems(...)` ที่ [internal/promotion/engine.go](../internal/promotion/engine.go#L433)
...
- fixed amount ห้ามเกิน base ที่ [internal/promotion/engine.go](../internal/promotion/engine.go#L328)
- apply to item ห้ามลดเกิน `FinalAmount` ของ item ที่ [internal/promotion/engine.go](../internal/promotion/engine.go#L455)
- final total ห้ามติดลบที่ [internal/promotion/engine.go](../internal/promotion/engine.go#L229)
...
ท้าย loop engine สรุปผลที่ [internal/promotion/engine.go](../internal/promotion/engine.go#L226)
...
mapping อยู่ที่ [internal/service/pricing_service.go](../internal/service/pricing_service.go#L142)
...
handler map business errors กลับเป็น HTTP status code ที่ [internal/handler/pricing_handler.go](../internal/handler/pricing_handler.go#L53)
...
error response shape จริงอยู่ที่ [internal/handler/api_error.go](../internal/handler/api_error.go#L14)
...
หลังคำนวณเสร็จ `PricingService` จะ persist log ที่ [internal/service/pricing_service.go](../internal/service/pricing_service.go#L185)
...
ทั้งหมดถูก marshaled เป็น JSON snapshot ที่ [internal/service/pricing_service.go](../internal/service/pricing_service.go#L196)
...
`List(...)` ที่ [internal/service/calculation_log_service.go](../internal/service/calculation_log_service.go#L49)

ใช้ดู history ของ calculation logs

### Detail

`GetByCalculationID(...)` ที่ [internal/service/calculation_log_service.go](../internal/service/calculation_log_service.go#L87)
...
`Replay(...)` ที่ [internal/service/calculation_log_service.go](../internal/service/calculation_log_service.go#L112)
...
- [internal/repository/product_repository.go](../internal/repository/product_repository.go#L45)
...
- [internal/repository/promotion_repository.go](../internal/repository/promotion_repository.go#L74)
...
- [internal/promotion/engine.go](../internal/promotion/engine.go#L232)
...
- [internal/service/pricing_service.go](../internal/service/pricing_service.go#L196)
