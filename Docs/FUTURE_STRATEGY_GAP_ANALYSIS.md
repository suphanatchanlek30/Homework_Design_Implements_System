...
- validation config ที่ [internal/service/promotion_service.go](../internal/service/promotion_service.go#L350)
...
- `RegisterAction` ที่ [internal/promotion/registry.go](../internal/promotion/registry.go#L39)
- `RegisterCondition` ที่ [internal/promotion/registry.go](../internal/promotion/registry.go#L43)
- supported actions ที่ [internal/promotion/registry.go](../internal/promotion/registry.go#L57)
- supported conditions ที่ [internal/promotion/registry.go](../internal/promotion/registry.go#L67)
...
- action execution path ที่ [internal/promotion/engine.go](../internal/promotion/engine.go#L230)
- condition execution path ที่ [internal/promotion/engine.go](../internal/promotion/engine.go#L259)
...
- `percentageActionHandler` ที่ [internal/promotion/engine.go](../internal/promotion/engine.go#L284)
- `fixedAmountActionHandler` ที่ [internal/promotion/engine.go](../internal/promotion/engine.go#L302)
- register ใน registry ที่ [internal/promotion/registry.go](../internal/promotion/registry.go#L81)
...
- `FREE_SHIPPING` อยู่ใน `SupportedActionTypes()` ที่ [internal/promotion/registry.go](../internal/promotion/registry.go#L57)
- `FREE_SHIPPING` ถูก register ใน default actions ที่ [internal/promotion/registry.go](../internal/promotion/registry.go#L81)
- handler จริงคือ `freeShippingActionHandler` ที่ [internal/promotion/engine.go](../internal/promotion/engine.go#L323)
...
- แต่ `SupportedActionTypes()` ไม่มี `BUY_X_GET_Y` ที่ [internal/promotion/registry.go](../internal/promotion/registry.go#L57)
- และไม่มี registration ใน default actions ที่ [internal/promotion/registry.go](../internal/promotion/registry.go#L81)
...
- ไม่มีใน `SupportedActionTypes()` ที่ [internal/promotion/registry.go](../internal/promotion/registry.go#L57)
- ไม่มี registration ใน registry ที่ [internal/promotion/registry.go](../internal/promotion/registry.go#L81)
...
- `USER_SEGMENT` อยู่ใน `SupportedConditionTypes()` ที่ [internal/promotion/registry.go](../internal/promotion/registry.go#L67)
- ถูก register ใน default conditions ที่ [internal/promotion/registry.go](../internal/promotion/registry.go#L89)
- แต่ผูกกับ `passthroughConditionHandler` ที่ [internal/promotion/registry.go](../internal/promotion/registry.go#L97)
- handler จริงคืน `true` ตลอดที่ [internal/promotion/engine.go](../internal/promotion/engine.go#L395)
...
- `FIRST_ORDER` อยู่ใน `SupportedConditionTypes()` ที่ [internal/promotion/registry.go](../internal/promotion/registry.go#L67)
- ถูก register เป็น passthrough ที่ [internal/promotion/registry.go](../internal/promotion/registry.go#L98)
- runtime handler คืน `true` ตลอดที่ [internal/promotion/engine.go](../internal/promotion/engine.go#L395)
...
- default registry mappings ใน [internal/promotion/registry.go](../internal/promotion/registry.go#L81)
- engine action execution path ใน [internal/promotion/engine.go](../internal/promotion/engine.go#L230)
- engine condition execution path ใน [internal/promotion/engine.go](../internal/promotion/engine.go#L259)
- placeholder free shipping handler ใน [internal/promotion/engine.go](../internal/promotion/engine.go#L323)
- passthrough condition handler ใน [internal/promotion/engine.go](../internal/promotion/engine.go#L395)
- promotion validation gate ใน [internal/service/promotion_service.go](../internal/service/promotion_service.go#L350)
