...
- `README.md` แนวคิดระบบที่ [README.md](/mnt/c/Homework_Design_Implements_System/README.md:15)
...
- action/condition enum ที่ [internal/model/models.go](/mnt/c/Homework_Design_Implements_System/internal/model/models.go:101)
...
- validation config ที่ [internal/service/promotion_service.go](/mnt/c/Homework_Design_Implements_System/internal/service/promotion_service.go:350)
...
- `RegisterAction` ที่ [internal/promotion/registry.go](/mnt/c/Homework_Design_Implements_System/internal/promotion/registry.go:39)
- `RegisterCondition` ที่ [internal/promotion/registry.go](/mnt/c/Homework_Design_Implements_System/internal/promotion/registry.go:43)
- supported actions ที่ [internal/promotion/registry.go](/mnt/c/Homework_Design_Implements_System/internal/promotion/registry.go:57)
- supported conditions ที่ [internal/promotion/registry.go](/mnt/c/Homework_Design_Implements_System/internal/promotion/registry.go:67)
...
- action execution path ที่ [internal/promotion/engine.go](/mnt/c/Homework_Design_Implements_System/internal/promotion/engine.go:230)
- condition execution path ที่ [internal/promotion/engine.go](/mnt/c/Homework_Design_Implements_System/internal/promotion/engine.go:259)
...
- `percentageActionHandler` ที่ [internal/promotion/engine.go](/mnt/c/Homework_Design_Implements_System/internal/promotion/engine.go:284)
- `fixedAmountActionHandler` ที่ [internal/promotion/engine.go](/mnt/c/Homework_Design_Implements_System/internal/promotion/engine.go:302)
- register ใน registry ที่ [internal/promotion/registry.go](/mnt/c/Homework_Design_Implements_System/internal/promotion/registry.go:81)
...
- `FREE_SHIPPING` อยู่ใน `SupportedActionTypes()` ที่ [internal/promotion/registry.go](/mnt/c/Homework_Design_Implements_System/internal/promotion/registry.go:57)
- `FREE_SHIPPING` ถูก register ใน default actions ที่ [internal/promotion/registry.go](/mnt/c/Homework_Design_Implements_System/internal/promotion/registry.go:81)
- handler จริงคือ `freeShippingActionHandler` ที่ [internal/promotion/engine.go](/mnt/c/Homework_Design_Implements_System/internal/promotion/engine.go:323)
...
- `BUY_X_GET_Y` อยู่ใน model enum ที่ [internal/model/models.go](/mnt/c/Homework_Design_Implements_System/internal/model/models.go:113)
- แต่ `SupportedActionTypes()` ไม่มี `BUY_X_GET_Y` ที่ [internal/promotion/registry.go](/mnt/c/Homework_Design_Implements_System/internal/promotion/registry.go:57)
- และไม่มี registration ใน default actions ที่ [internal/promotion/registry.go](/mnt/c/Homework_Design_Implements_System/internal/promotion/registry.go:81)
...
- `BUNDLE_DISCOUNT` อยู่ใน model enum ที่ [internal/model/models.go](/mnt/c/Homework_Design_Implements_System/internal/model/models.go:113)
- ไม่มีใน `SupportedActionTypes()` ที่ [internal/promotion/registry.go](/mnt/c/Homework_Design_Implements_System/internal/promotion/registry.go:57)
- ไม่มี registration ใน registry ที่ [internal/promotion/registry.go](/mnt/c/Homework_Design_Implements_System/internal/promotion/registry.go:81)
...
- `USER_SEGMENT` อยู่ใน `SupportedConditionTypes()` ที่ [internal/promotion/registry.go](/mnt/c/Homework_Design_Implements_System/internal/promotion/registry.go:67)
- ถูก register ใน default conditions ที่ [internal/promotion/registry.go](/mnt/c/Homework_Design_Implements_System/internal/promotion/registry.go:89)
- แต่ผูกกับ `passthroughConditionHandler` ที่ [internal/promotion/registry.go](/mnt/c/Homework_Design_Implements_System/internal/promotion/registry.go:97)
- handler จริงคืน `true` ตลอดที่ [internal/promotion/engine.go](/mnt/c/Homework_Design_Implements_System/internal/promotion/engine.go:395)
...
- `FIRST_ORDER` อยู่ใน `SupportedConditionTypes()` ที่ [internal/promotion/registry.go](/mnt/c/Homework_Design_Implements_System/internal/promotion/registry.go:67)
- ถูก register เป็น passthrough ที่ [internal/promotion/registry.go](/mnt/c/Homework_Design_Implements_System/internal/promotion/registry.go:98)
- runtime handler คืน `true` ตลอดที่ [internal/promotion/engine.go](/mnt/c/Homework_Design_Implements_System/internal/promotion/engine.go:395)
...
- แนวคิด data-driven และ registry ใน [README.md](/mnt/c/Homework_Design_Implements_System/README.md:15)
- model action/condition enums ใน [internal/model/models.go](/mnt/c/Homework_Design_Implements_System/internal/model/models.go:101)
- registry definition และ supported lists ใน [internal/promotion/registry.go](/mnt/c/Homework_Design_Implements_System/internal/promotion/registry.go:24)
- default registry mappings ใน [internal/promotion/registry.go](/mnt/c/Homework_Design_Implements_System/internal/promotion/registry.go:81)
- engine action execution path ใน [internal/promotion/engine.go](/mnt/c/Homework_Design_Implements_System/internal/promotion/engine.go:230)
- engine condition execution path ใน [internal/promotion/engine.go](/mnt/c/Homework_Design_Implements_System/internal/promotion/engine.go:259)
- placeholder free shipping handler ใน [internal/promotion/engine.go](/mnt/c/Homework_Design_Implements_System/internal/promotion/engine.go:323)
- passthrough condition handler ใน [internal/promotion/engine.go](/mnt/c/Homework_Design_Implements_System/internal/promotion/engine.go:395)
- promotion validation gate ใน [internal/service/promotion_service.go](/mnt/c/Homework_Design_Implements_System/internal/service/promotion_service.go:350)
